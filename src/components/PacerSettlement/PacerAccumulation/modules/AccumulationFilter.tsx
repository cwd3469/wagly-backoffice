...
const AccumulationFilter = (): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        <InputLabel id="accumulation-select-label">적립 상태</InputLabel>
        <Select
        ...
        >
          <MenuItem value={'consent'}>확정</MenuItem>
          <MenuItem value={'pickupWait'}>확정 전</MenuItem>
          <MenuItem value={'Delivering'}>상점 요청 회수</MenuItem>
        </Select>
      </FormControl>
    </Box>
  );
