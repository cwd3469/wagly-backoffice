...
import UserPacerSubBase from './UserStoreSubBase';
import UserPacerSubAddInfo from './UserPacerSubAddInfo';
import UserPacerSubArea from './UserStoreSubArea';
    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ border: '#eee solid 1px' }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          ...
          <Tab label="추가 정보" {...a11yProps(1)} />
          <Tab label="사업자 등록증" {...a11yProps(2)} />
        </Tabs>
      </Box>
