...
const PostFaqFilter = (): JSX.Element => {
  ...
  const [faqSelect, setfaqSelect] = React.useState('');
  const faqSelectHandleChange = (event: SelectChangeEvent) => {
    setfaqSelect(event.target.value as string);
  };
  ...
  return (
    ...
    >
      ...
      >
        <InputLabel id="faq-select-label">FAQ 타입</InputLabel>
        <Select
          labelId="faq-select-label"
          id="faq-select"
          value={faqSelect}
          label="Age"
          onChange={faqSelectHandleChange}
        >
          <MenuItem value={'consent'}>서비스 이용</MenuItem>
          <MenuItem value={'cisagree'}>담당자 연락</MenuItem>
        </Select>
      </FormControl>
